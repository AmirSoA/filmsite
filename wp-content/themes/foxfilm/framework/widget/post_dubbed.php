<?php
class wp_widget_post_dubbed extends WP_Widget {

function __construct() {
parent::__construct(
// آی دی ابزارک
'wp_widget_post_dubbed', 
 
// نام ابزارک
__('فیلم های دوبله - سایدبار', ''), 
...
if (!$cats = $instance["cats"]){$cats = '';}
	?>
 		<!-- box doblor -->
 		<div class="box dub"><div class="title"><h4><?php echo $title ?></h4></div>
 		<ul class="cat">
 			 	 <?php
                  $args = array(
                      "cat" =>  $cats,
...
$title = __( 'فیلم های دوبله', 'wp_widget_domain_post' );
}
...
// ثبت ابزارک
function wp_load_wp_widget_post_dubbed() {
    register_widget( 'wp_widget_post_dubbed' );
}
add_action( 'widgets_init', 'wp_load_wp_widget_post_dubbed' );
?>