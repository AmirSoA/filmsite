<?php
class wp_widget_post_category extends WP_Widget {

function __construct() {
parent::__construct(
// آی دی ابزارک
'wp_widget_post_category', 
 
// نام ابزارک
__('نوشته های جدید با دسته بندی - سایدبار', ''), 
		...
		<!-- box category -->
 		<div class="box category">
 			<div class="title"><h4><?php echo $title ?></h4></div>
 				...
 				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a><span><?php comments_number(); ?></span><span><?php the_time('j F  Y'); ?></span></li>
                          <?php
...
$title = __( 'فیلم های جدید', 'wp_widget_domain_post' );
}
...
// ثبت ابزارک
function wp_load_wp_widget_post_category() {
    register_widget( 'wp_widget_post_category' );
}
add_action( 'widgets_init', 'wp_load_wp_widget_post_category' );
?>